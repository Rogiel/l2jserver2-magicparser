 ...
 * 
 */
public class BytePart extends DataPart<BytePacketPartDescriptor, Byte> {
	/**
	 * @param part
	 *            the packet part descriptor
	 */
	public BytePart(BytePacketPartDescriptor part) {
		super(part, 1, new RGB(255, 102, 102), "b");
	}
	...
	public String getValueAsString() {
		return new StringBuilder("0x").append(ByteUtils.rawHexDump(value))
				.toString();
	}
}

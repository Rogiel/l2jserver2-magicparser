 ...
 */
public class FloatPart extends DataPart<FloatPacketPartDescriptor, Float> {
	/**
	 * @param part
	 *            the packet part
	 */
	public FloatPart(FloatPacketPartDescriptor part) {
		super(part, 4, new RGB(255, 255, 153), "f");
	}
